...
// #1901 refresh: the pipeline segment of this baseline previously encoded the
// zero-evidence PLANNER-active mislabel ("stage: PLANNER active" + a
// --current --glow planner step on a ticket with NO role events). Updated to
// the honest zero-evidence render (all steps pending, "stage: working, no
// role recorded yet") — the surrounding drawer bytes are unchanged, so the
// test still guards what it always did: #1816's on-hold feature must not
// alter a NON-held ticket's drawer.
const EXPECTED_NO_HOLD_DRAWER =
  '<div class="ak-scrim" style="opacity:0"></div><aside class="ak-drawer" role="dialog" aria-modal="true" aria-label="Ticket #100 audit log" style="transform:translateY(100%)"><span class="ak-drawer__grip" aria-hidden="true"></span><div class="ak-drawer__head"><span class="ak-drawer__id">#100</span><span class="ak-chip" style="--hue:var(--prog)">In Progress</span><button type="button" class="ak-drawer__close" aria-label="Close">✕</button></div><div class="ak-drawer__body" data-ak-pulldown="true"><h2 class="ak-drawer__title">Do the thing</h2><div class="ak-pipeline-wrap"><div class="ak-pipeline" role="img" aria-label="stage: working, no role recorded yet"><div class="ak-pipeline__step ak-pipeline__step--pending" style="--step:var(--prog)"><span class="ak-pipeline__bar" aria-hidden="true"></span><span class="ak-pipeline__label"><span class="ak-pipeline__label-text">PLANNER</span></span></div><div class="ak-pipeline__step ak-pipeline__step--pending" style="--step:var(--review)"><span class="ak-pipeline__bar" aria-hidden="true"></span><span class="ak-pipeline__label"><span class="ak-pipeline__label-text">PLAN-REVIEW</span></span></div><div class="ak-pipeline__step ak-pipeline__step--pending" style="--step:var(--live)"><span class="ak-pipeline__bar" aria-hidden="true"></span><span class="ak-pipeline__label"><span class="ak-pipeline__label-text">EXECUTOR</span></span></div><div class="ak-pipeline__step ak-pipeline__step--pending" style="--step:var(--done)"><span class="ak-pipeline__bar" aria-hidden="true"></span><span class="ak-pipeline__label"><span class="ak-pipeline__label-text">EXEC-REVIEW</span></span></div></div></div><p class="ak-drawer__section">Black-box timeline</p><p class="ak-timeline__empty">No role events recorded yet.</p></div></aside>';
